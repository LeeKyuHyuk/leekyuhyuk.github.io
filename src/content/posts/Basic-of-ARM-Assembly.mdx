...
author: KyuHyuk Lee
pubDatetime: 2019-05-15T20:36:56.000Z
slug: Basic-of-ARM-Assembly
featured: false
draft: false
tags:
  - ARM Architecture
description: ARM CPU 레지스터 구조, MOV/LDR/STR 명령어 (Post/Pre indexing 포함), 비트 조작 (ORR/EOR/AND/BIC), 분기 (B, CMP, 조건부 분기), 산술 연산, 서브루틴 (BL/BX) 등 ARM Assembly의 핵심 명령어와 CPSR 플래그를 설명합니다.
---
...
- ARM CPU의 기본 구성
  ...
  - `CPSR`이라는 상태 레지스터를 가지고 있습니다.  
    ![Operand](@/assets/images/Basic-of-ARM-Assembly/operand.jpg)
...
- `MOV R0, #0x7F00` : **가능** ![Example 1](@/assets/images/Basic-of-ARM-Assembly/example1.png)

- `MOV R0, #0x30C0` : **가능** ![Example 2](@/assets/images/Basic-of-ARM-Assembly/example2.png)

- `MOV R3, #0x14E` : **불가능** ![Example 3](@/assets/images/Basic-of-ARM-Assembly/example3.png)
...
![LDR, STR 쉽게 이해하는 방법](@/assets/images/Basic-of-ARM-Assembly/ldr_str_tip.png)
...
![Example 4](@/assets/images/Basic-of-ARM-Assembly/example4.png)
...
![CPSR - https://www.wikinote.org/Main/Savitribai-Phule-Pune-University/ENTC/AP-TE/Unit-1/Registers-CPSR-SPSR/](@/assets/images/Basic-of-ARM-Assembly/cpsr.jpg)
...
- `BL label` : Branch and Link
  ...
  - `B`와 달리 복귀한 주소(따음 명령 주소) 값을 `R14`에 저장합니다.  
    ![Subroutine](@/assets/images/Basic-of-ARM-Assembly/subroutine.png)

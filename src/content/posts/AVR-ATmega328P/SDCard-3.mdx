---
title: ATmega328P SDCard 구현 (3)
author: KyuHyuk Lee
pubDatetime: 2022-09-02T23:57:51.000Z
slug: sdcard-3
featured: false
draft: false
tags:
  ...
  - ATmega328P
  - SDCard
description: ATmega328P의 SDCard SPI 초기화 3편 입니다. CMD55 → ACMD41 순서로 SDCard를 Ready 상태로 전환하고, 1초 타임아웃/재시도 로직 포함해 초기화 함수를 완성하는 과정을 설명합니다.
---

[이전 글](/posts/avr-atmega328p/sdcard-2)에서 `CMD0`, `CMD8` 그리고 `CMD58`을 사용하는 방법을 소개했습니다. 이제 SDCard의 초기화 과정을 거의 완료했습니다. 아래 다이어그램을 보면 다음 단계는 `ACMD41`라는 것을 알 수 있습니다.
...
![CMD55 Format](@/assets/images/AVR-ATmega328P/SDCard-3/AVR-ATmega328P-SDCard-3_1.png)

`ACMD41`의 형식은 아래와 같습니다:

![ACMD41 Format](@/assets/images/AVR-ATmega328P/SDCard-3/AVR-ATmega328P-SDCard-3_2.png)
...
[이전 글](/posts/avr-atmega328p/sdcard-2)에서 작성한 `main()`을 아래와 같이 수정합니다.
...
![CLI 1](@/assets/images/AVR-ATmega328P/SDCard-3/AVR-ATmega328P-SDCard-3_3.png)

SDCard가 Ready가 되었다면, CCS를 얻기 위해 마지막에 `CMD58`을 보냅니다.  
![CLI 2](@/assets/images/AVR-ATmega328P/SDCard-3/AVR-ATmega328P-SDCard-3_4.png)

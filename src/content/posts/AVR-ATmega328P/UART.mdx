---
title: ATmega328P UART 구현
author: KyuHyuk Lee
pubDatetime: 2022-08-28T10:35:33.000Z
slug: uart
featured: false
draft: false
tags:
  ...
  - ATmega328P
  - UART
description: ATmega328P UART 구현 — UART 초기화 방법, Baudrate 설정, 문자 및 문자열 전송, 16진수/10진수 출력 함수, 데이터 수신을 설명합니다.
---
...
![Connections](@/assets/images/AVR-ATmega328P/UART/AVR-ATmega328P-UART_1.png)
...
![Buadrate Calc](@/assets/images/AVR-ATmega328P/UART/AVR-ATmega328P-UART_2.png)
...
![ArduinoISP](@/assets/images/AVR-ATmega328P/UART/AVR-ATmega328P-UART_3.png)
...
![Build and Flash](@/assets/images/AVR-ATmega328P/UART/AVR-ATmega328P-UART_4.png)

`minicom`로 ATmega328P에 연결된 UART에 접속해서 정상적으로 동작하는지 확인해 봅니다.  
입력한 값이 그대로 출력된다면 정상 작동하는 것입니다.  
![minicom](@/assets/images/AVR-ATmega328P/UART/AVR-ATmega328P-UART_5.png)

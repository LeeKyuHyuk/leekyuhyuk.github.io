---
title: ATmega328P SPI 구현
author: KyuHyuk Lee
pubDatetime: 2022-08-28T15:21:12.000Z
slug: spi
featured: false
draft: false
tags:
  ...
  - ATmega328P
  - SPI
description: ATmega328P SPI 구현 — SPI 프로토콜 개요, 마스터 초기화, 데이터 송수신 함수(Transmit/Receive/TxRx), Slave Select 제어 방법을 설명합니다.
---
...
![SPI Layout](@/assets/images/AVR-ATmega328P/SPI/2022-08-28-AVR-ATmega328P-SPI_1.png)

...
author: KyuHyuk Lee
pubDatetime: 2019-05-14T19:39:57.000Z
slug: Raspberry-Pi-Bare-Bones
featured: false
draft: false
tags:
  - ARM Architecture
  - Raspberry Pi
description: "Raspberry Pi Model B/2/3에서 OS를 개발하는 가이드: 크로스 컴파일러 빌드, 부트 어셈블리, UART UART 기반 커널 구현, 리눅커 스크립트, 부팅까지 전 과정을 설명합니다."
---

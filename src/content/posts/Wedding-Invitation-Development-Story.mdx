...
author: KyuHyuk Lee
pubDatetime: 2021-10-01T23:29:24.000Z
slug: Wedding-Invitation-Development-Story
featured: false
draft: false
ogImage: ../../assets/images/Wedding-Invitation-Development-Story/Wedding-Invitation-Development-Story.png
tags:
  - KyuHyuk Lee
  - React
description: "React를 사용한 나만의 모바일 청첩장을 React, Ant Design, Styled-Components로 개발한 후기: 요구사항, KakaoLink/KakaoTalk 공유, GitHub Pages 배포와 WebView/로딩/성능 문제 해결 경험"
---

import previewVideo from "@/assets/videos/Wedding-Invitation-Development-Story/Wedding-Invitation-Development-Story.mp4";
...
<video controls style="width: 100%; max-width: 374px;" preload="metadata">
...
- Github Pages의 속도가 생각보다 빠르지가 않아서 사진과 영상의 파일 사이즈를 적정선으로 줄이는데 노력을 많이 했습니다.  
  ...
  ![Chrome 개발자 모드](@/assets/images/Wedding-Invitation-Development-Story/2021-10-01-Wedding-Invitation-Development-Story.png)
